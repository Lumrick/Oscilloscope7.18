...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net adc_0_oe [get_bd_ports oe_0] [get_bd_pins adc_0/oe]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_in1_0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_out1_0] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk]
  connect_bd_net -net data_0_1 [get_bd_ports data_0] [get_bd_pins adc_0/data] [get_bd_pins ila_0/probe0]
